      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="10" cellspacing="0" bgcolor="#CCCCCC">
          <tr>
            ...
            <td bgcolor="#CCCCCC"><span class="style5">Products</span></td>
          ...
          <tr>
			...
			<tr bgcolor="#CCCCCC">
			  ...
			  ?>
                ...
                <td><input name="Description_add" type="text" value="" required="required"></td>
                
                <td><div align="center">
                  <input name="Price_add" type="text"   >
                </div></td>
				<td><div align="center">
                  <input name="Make_add" type="number"  >
                </div></td>
                <td><div align="center">
			  ...
			  <form action="<?php echo site_url('admin/update_product');?>" method="post" enctype="multipart/form-data">
			  <tr>
                ...
                <td><div align="center">
                  <input name="Name" type="text" value="<?php echo $d['Name'];?>" size="">
				   <input name="oldCategories" type="hidden" value=" <?php echo $d['Name'];?>  ">
                </div></td>
                <td><div align="center">
                 <select name="Category" >	
						 <?php if(sizeof($cat_array)!=0){
			  foreach($cat_array as $s){
				  if($s['ID']==$d['Category'] ){
			  ?>
			  
		              <option value="<?php echo $s['ID'];?> " selected="selected"><?php echo $s['Name'];?></option> 
				  <?php } else {?>
                ...
                <td><textarea name="Description" rows="5"><?php echo $d['Description']?></textarea></td>
                 <td><div align="center">
                  <input name="Price" type="text" value="<?php echo $d['Price'];?>" size="">
                </div></td>
				 <td><div align="center">
                  <input name="Make" type="number" value="<?php echo $d['Make'];?>" size="">
                </div></td>
